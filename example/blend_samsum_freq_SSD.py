...
llm = LLM(model="/home/lifei/model/Mistral-7B-Instruct-v0.3", gpu_memory_utilization=0.95)
tokenizer = AutoTokenizer.from_pretrained("/home/lifei/model/Mistral-7B-Instruct-v0.3")
