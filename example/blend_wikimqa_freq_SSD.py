...
parser = argparse.ArgumentParser(description="CacheTune WikiMQA SSD script")
...
parser.add_argument("--disk-cache-root", type=str, default="disk_offload_cache/wikimqa")
...
query_prompt = (
    "\n\nAnswer the question based on the given passages. Answer the question within 5 words. "
