...
def resolve_hotpot_dataset_path():
    candidates = [
        ...
        Path("/home/lifei/dataset/HotpotQA/raw/hotpot_dev_distractor_v1.json"),
    ]
...
parser = argparse.ArgumentParser(description="CacheTune HotpotQA script")
...
for sample_idx, ex in enumerate(eval_dataset):
    ...
    res = normalize_pred_for_eval(output[0].outputs[0].text)
